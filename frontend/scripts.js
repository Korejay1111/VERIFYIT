...
const translations = {
  en: {
    ...
    hero_paragraph: 'Kindly Paste an article or upload a screenshot — our multi-model AI engine analyzes text, cross-references sources, and delivers a credibility score in seconds.',
